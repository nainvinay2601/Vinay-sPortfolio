...
{["Prototype","Full case study"].map((item,index)=>( 
   <div  key={index}  className="links flex items-center justify-center gap-3 mt-5 buttonInfo border border-solid border-zinc-200 rounded-full px-4 py-1 w-fit group bg-[#fffce1] text-[#000] font-medium  uppercase   ">
