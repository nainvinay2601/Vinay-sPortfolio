...
function ReadyForProject() {
  ...
  return (
    <div
      ...
      className="w-full h-full relative   rounded-tr-3xl rounded-tl-3xl py-5 md:py-2 bg-[#f1b8f2] flex items-center justify-center  "
    >
      <div className="textAndButton">
        <div
          className="md:text-[14vw] text-[12vw]  text-red-600   
       uppercase text-center  font-founders-grotesk leading-none"
        >
          <h1>Ready</h1>
          <h1>TO Start</h1>
          <h1>
